# plan-de-accion Specification

## Purpose
Las tareas de un plan de acción: con qué se trabaja un plan después de
decidirlo. Cada tarea tiene su responsable y su fecha, cuelga de un solo lugar
(una obligación, un plan, o ninguno), se consulta por persona entre planes y
sobrevive al retiro del plan. Viven en la misma tabla que las tareas de las
obligaciones, así que calendario y "lo que le toca a una persona" las ven sin
un segundo concepto de tarea. Viene del cambio `modelo-de-tareas-del-plan-de-accion` (#169).
