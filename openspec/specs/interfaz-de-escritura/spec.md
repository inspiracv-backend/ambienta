# interfaz-de-escritura Specification

## Purpose
Qué garantiza la interfaz cuando alguien cambia un dato: que lo que queda a la
vista es lo que quedó guardado, que un campo se lee de donde se escribe, y que
un rechazo se explica con un motivo estable. Existe porque la forma más cara de
fallar en este sistema es la silenciosa: una pantalla que confirma un cambio que
al recargar ya no está, y que nadie investiga hasta que un cliente reclama por un
dato que "sí había guardado". Viene del cambio `escrituras-de-la-interfaz`.
